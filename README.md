...
- **Core Skill** — Top-level configuration with coding specifications, configuration management, and workflow guidelines
...
- **Configuration Reference** — First-time setup and configuration documentation
